...
http://docs.atlassian.com/jira/docs-064/Importing+Data+from+Bugzilla
http://docs.atlassian.com/jira/docs-064/Importing+Data+From+Mantis

 - customize/write a service to work with JIRA:

http://docs.atlassian.com/jira/docs-064/Services
...
source
(http://docs.atlassian.com/jira/docs-064/Building+JIRA+from+Source). The
